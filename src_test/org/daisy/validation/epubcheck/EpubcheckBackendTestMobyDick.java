...
//
// NOTE:
// This file has been generated by running the script from the root of this eclipse project.
// java -cp `ls lib/ | perl -ne 'my $line; chomp;push(@lines,"lib/$_"); END {print join(":", @lines);}'` com.adobe.epubcheck.tool.Checker resources/9780316000000_MobyDick_r6.epub 2>&1 | perl resources/mkTsts.pl > Bla.java
// 
...
public class EpubcheckBackendTestMobyDick {
	...
	public void testMobyDick() {
		...
		Issue issue = null;
		assertEquals(185, issues.size());
		int i = 0;

        issue = issues.get(i++);
        assertEquals("Version", issue.type);
        assertNull(issue.file);
        assertEquals("3.0", issue.txt);
